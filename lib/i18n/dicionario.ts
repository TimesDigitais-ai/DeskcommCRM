...
export const DICIONARIO: Traducoes = {
  "Espelho da Inbox": { es: "Espejo de Inbox" },
  "Acompanhe mensagens de uma central externa. O atendimento continua na origem; este CRM não envia respostas nem inicia automações nessas conversas.": { es: "Consulte mensajes de una central externa. La atención continúa en el origen; este CRM no envía respuestas ni inicia automatizaciones en estas conversaciones." },
  "Compatível com eventos da Attemics. Nesta etapa, anexos aparecem como aviso para consultar na origem.": { es: "Compatible con eventos de Attemics. En esta etapa, los archivos adjuntos aparecen como un aviso para consultarlos en el origen." },
  "Carregando espelhos…": { es: "Cargando espejos…" },
  "Recepção habilitada": { es: "Recepción habilitada" },
  "Recepção pausada": { es: "Recepción pausada" },
  "Última mensagem recebida:": { es: "Último mensaje recibido:" },
  "Aguardando a primeira mensagem — configurar a URL não confirma a entrega.": { es: "Esperando el primer mensaje — configurar la URL no confirma la entrega." },
  "A última entrega falhou. Confira o histórico do webhook na origem antes de repetir o teste.": { es: "La última entrega falló. Consulte el historial del webhook en el origen antes de repetir la prueba." },
  "Pausar recepção": { es: "Pausar recepción" },
  "Retomar recepção": { es: "Reanudar recepción" },
  "Espelho criado. Cadastre esta URL em um webhook adicional na origem.": { es: "Espejo creado. Registre esta URL en un webhook adicional en el origen." },
  "A URL é privada e só aparece nesta criação. Preserve o webhook de atendimento atual.": { es: "La URL es privada y solo aparece al crearla. Conserve el webhook de atención actual." },
  "URL privada do webhook": { es: "URL privada del webhook" },
  "Copiar URL": { es: "Copiar URL" },
  "Selecione mensagem recebida, enviada e atualizada, filtrando pelos números cadastrados. Depois envie uma mensagem de teste pelo seu WhatsApp e confira a Inbox.": { es: "Seleccione mensaje recibido, enviado y actualizado, filtrando por los números registrados. Luego envíe un mensaje de prueba desde su WhatsApp y revise Inbox." },
  "Adicionar espelho": { es: "Añadir espejo" },
  "Identificador da empresa na origem": { es: "Identificador de la empresa en el origen" },
  "Use o companyId do evento da sua central para impedir a mistura entre empresas.": { es: "Use el companyId del evento de su central para evitar mezclar empresas." },
  "Números atendidos, com DDI": { es: "Números atendidos, con prefijo internacional" },
  "Criar espelho somente leitura": { es: "Crear espejo de solo lectura" },
  "Não foi possível consultar o espelho.": { es: "No fue posible consultar el espejo." },
  "Falha ao criar espelho.": { es: "Error al crear el espejo." },
  "Falha ao alterar espelho.": { es: "Error al modificar el espejo." },
  "Conversa espelhada": { es: "Conversación reflejada" },
  "Somente leitura · atendimento na plataforma de origem": { es: "Solo lectura · atención en la plataforma de origen" },
  "Espelho somente leitura. Para responder, use a plataforma onde este número já é atendido.": { es: "Espejo de solo lectura. Para responder, use la plataforma donde ya se atiende este número." },
  ...
  "Limite de etiquetas atingido.": { es: "Se alcanzó el límite de etiquetas." },
  // ─── Etiquetas: escolher na lista (Inbox, funil, editar lead) ───
  "Etiquetas escolhidas": { es: "Etiquetas elegidas" },
  "Nenhuma etiqueta escolhida.": { es: "Ninguna etiqueta elegida." },
  "Remover etiqueta": { es: "Quitar etiqueta" },
  "Buscar etiqueta": { es: "Buscar etiqueta" },
  "Buscar etiqueta…": { es: "Buscar etiqueta…" },
  "Fora do cadastro": { es: "Fuera del registro" },
  "Automáticas": { es: "Automáticas" },
  "só o agente": { es: "solo el agente" },
  "Nenhuma etiqueta cadastrada. Cadastre em Configurações → Tags.": { es: "Ninguna etiqueta registrada. Regístrela en Configuración → Tags." },
  "automática — só a cor muda": { es: "automática — solo cambia el color" },
  "Nova etiqueta": { es: "Nueva etiqueta" },
  "Nome da etiqueta": { es: "Nombre de la etiqueta" },
  "Etiqueta cadastrada.": { es: "Etiqueta registrada." },
  "Esta etiqueta é aplicada automaticamente e só pode mudar de cor.": { es: "Esta etiqueta se aplica automáticamente y solo se puede cambiar de color." },
  "Setor na plataforma de origem": { es: "Sector en la plataforma de origen" },
  "Atendente na plataforma de origem": { es: "Agente en la plataforma de origen" },
  "Carregando as etiquetas do contato…": { es: "Cargando las etiquetas del contacto…" },
  "Não deu para ler as etiquetas do contato. Recarregue a página para editá-las.": {
    es: "No se pudieron leer las etiquetas del contacto. Recargue la página para editarlas.",
  },
